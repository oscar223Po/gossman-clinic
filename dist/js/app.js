    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".review__slider")) new swiper_core_Swiper(".review__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".controlls__arrow--prev",
                    nextEl: ".controlls__arrow--next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.15,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            function handleScroll() {
                if (window.scrollY >= 10) heroImage.classList.add("disable-z-index"); else heroImage.classList.remove("disable-z-index");
            }
            ...
            if (tabTitles !== null) tabTitles.forEach((title => {
                title.addEventListener("click", (() => {
                    if (title.classList.contains("title-active")) return;
                    const activeTab = document.querySelector(".tabs__title.title-active");
                    if (activeTab) activeTab.classList.remove("title-active");
                    title.classList.add("title-active");
                    if (tabNavigation.classList.contains("nav-toggle")) tabNavigation.classList.remove("nav-toggle"); else tabNavigation.classList.add("nav-toggle");
                }));
            }));
            const reviewsButton = document.querySelector(".reviews__button");
            if (reviewsButton !== null) reviewsButton.addEventListener("click", (function() {
                ...
                columns.forEach((column => {
                    ...
                    for (let i = 0; i < 2; i++) if (hiddenReviews[i]) hiddenReviews[i].classList.add("visible");
                    if (hiddenReviews.length <= 2) this.style.display = "none";
                }));
            }));
        }));
        window["FLS"] = false;
